...
class KycScreen extends StatefulWidget {
  ...
  String?lat;
  String?lang;
   KycScreen({Key? key,this.name,this.email,this.mobile,this.companyname,this.designation,this.role,this.comaddress,this.comstate,this.comarea,this.comcity,this.compincode,this.combuildingNo,this.password,this.lang,this.lat}) : super(key: key,);
      ...
      body: SingleChildScrollView(
        child: Column(children: [
          Container(height: 80,
            ...
            Text('KYC',style: TextStyle(fontWeight: FontWeight.bold,color: AppColors.whiteTemp,fontSize: 20),),
          ...
          Padding(
            ...
            child: Form(
              ...
              Row(children: [
                ...
                Text('KYC for Distributors:',style: TextStyle(fontWeight: FontWeight.bold,color: AppColors.blackTemp,fontSize: 15),):

                widget.role=="6"?
                Text('KYC for Mechanic Owners:',style: TextStyle(fontWeight: FontWeight.bold,color: AppColors.blackTemp,fontSize: 15),):

                      widget.role=="4"?

                Text('KYC for Retailers:',style: TextStyle(fontWeight: FontWeight.bold,color: AppColors.blackTemp,fontSize: 15),):

                      widget.role=="5"?
                Text('KYC for workshop owners:',style: TextStyle(fontWeight: FontWeight.bold,color: AppColors.blackTemp,fontSize: 15),)
:SizedBox()
...
Column(children: [
  ...
  SizedBox(height: 10,)
                ...
                CustomTemtextField(
                    controllerfield: currentphycionaaddress,
                    hinttext: "Current Physical Address",
                    itemcount: 50,
                    imagedataa: "assets/images/COMPANY NAME.png"),
                          ...
                          Navigator.push(context, MaterialPageRoute(
                            builder: (context) =>
                                BankdetailsScr(
                                    ...
                                    currentphysicaladdress: currentphycionaaddress
                                        .text,
