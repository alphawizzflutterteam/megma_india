...
SizedBox(height: 10,),
  ...
  List<String> technician_typeList = ['Owner', 'Purchase Manager', 'Accountant','Chief Mechanic'];
  ...
  void getRole() {
    apiBaseHelper.getAPICall(getRoleurl).then((getData) {
      ...
      if (error) {
        ...
        setState(() {
          // for (int i = 0; i < getRolModel!.data!.length; i++) {
          //   getRoleList.add(getRolModel!.data![i]);
          // }
