...
class BankdetailsScr extends StatefulWidget {
  ...
  BankdetailsScr({Key? key,this.lang,this.lat,this.name,this.email,this.mobile,this.companyname,this.designation,this.role,this.comaddress,this.comstate,this.comarea,this.comcity,this.compincode,this.combuildingNo,this.pan,this.gst,this.currentphysicaladdress,this.password}) : super(key: key,);
